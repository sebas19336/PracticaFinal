...
public class vectores {
    ...
    int nroSemestre = sc.nextInt();
    o.setNroSemestre(nroSemestre);
    System.out.println("Ingrese el promedio acumulado.");
    Float promAcum = sc.nextFloat();
    o.setPromAcum(promAcum);
    System.out.println("Ingrese el serial asignado.");
    String SerialI = sc.next();
    o.setSerialI(SerialI);
    return o;
   }
    ...
    int cantidadMa = sc.nextInt();
    o.setCantidadMa(cantidadMa);
    System.out.println("Ingrese el serial asignado.");
    int SerialD = sc.nextInt();
    o.setSerialD(SerialD);
    return o;
   }
